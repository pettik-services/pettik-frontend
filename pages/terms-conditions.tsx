...
const TermsAndConditions = () => {
  return (
    <div className='font-sans px-6 pt-12 md:pt-0 pb-12 md:px-24 flex flex-col gap-y-4'>
      <h1 className='font-nunito-black'>Terms and Conditions</h1>
      <p>Welcome to Pettik!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of Pettik services Private Limited's Website, located at &nbsp;
        <a href={webUrl}>{webUrl}</a>.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Pettik if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Pettik, you agreed to use
        cookies in agreement with the Pettik services Private Limited's Privacy
        Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, Pettik services Private Limited and/or its
        licensors own the intellectual property rights for all material on
        Pettik. All intellectual property rights are reserved. You may access
        this from Pettik for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>
      <p>You must not:</p>
      <ul className='pl-6 list-disc'>
        <li>Republish material from Pettik</li>
        <li>Sell, rent or sub-license material from Pettik</li>
        <li>Reproduce, duplicate or copy material from Pettik</li>
        <li>Redistribute content from Pettik</li>
      </ul>
      <p>
      ...
      <p>
        ...
        Pettik services Private Limited does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of Pettik services Private Limited,its agents
        ...
        laws, Pettik services Private Limited shall not be liable for the
      ...
      <p>
        Pettik services Private Limited reserves the right to monitor all
      ...
      <p>
        You hereby grant Pettik services Private Limited a non-exclusive license
      ...
      <p>
        ...
        the hyperlink compensates the absence of Pettik services Private
      ...
      <p>
        ...
        e-mail to Pettik services Private Limited. Please include your name,
      ...
      <p>
        No use of Pettik services Private Limited's logo or other artwork will
