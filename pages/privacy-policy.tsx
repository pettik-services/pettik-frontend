...
const PrivacyPolicy = () => {
  return (
    <div className='font-sans px-6 pt-12 md:pt-0 pb-12 md:px-24 flex flex-col gap-y-4'>
      <h1 className='font-nunito-black'>
      ...
      <p>
        ...
        advertising partners of Pettik.
      </p>
      <p>
      ...
      <p>
        Note that Pettik has no access to or control over these cookies that are
      ...
      <p>
        Pettik does not knowingly collect any Personal Identifiable Information
